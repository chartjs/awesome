...
## Adapters
  ...
  Support | Name | Description
  -- | -- | --
  2️⃣ 3️⃣ 4️⃣ | [dayjs](https://github.com/bolstycjw/chartjs-adapter-dayjs-4) | dayjs adapter (<4KB gzipped)
  2️⃣ 3️⃣ 4️⃣ | [date-fns](https://github.com/chartjs/chartjs-adapter-date-fns) | date-fns adapter (60KB gzipped)
  2️⃣ 3️⃣ 4️⃣ | [luxon](https://github.com/chartjs/chartjs-adapter-luxon) | Luxon adapter (26KB gzipped)
